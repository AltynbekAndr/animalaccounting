...
import kz.putinbyte.iszhfermer.entities.iszh.Сharacteristics
import kz.putinbyte.iszhfermer.presentation.base.BaseView
import moxy.viewstate.strategy.alias.Skip

interface AddOwnersView : BaseView {
    ...
    @AddToEndSingle
    fun showCharacteristicsData(сharacteristics: Сharacteristics?)
    ...
    @AddToEndSingle
    fun showProduction(items: List<BaseFormat>)
